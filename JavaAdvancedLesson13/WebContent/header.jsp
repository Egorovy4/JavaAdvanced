...
<div id="wrapper" class="animate">
	<nav
		...
		<span class="navbar-toggler-icon leftmenutrigger"></span> <a
			class="navbar-brand" href="#">Books</a>
		...
		<div class="collapse navbar-collapse" id="navbarText">
			<ul class="navbar-nav animate side-nav">
				<li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/cabinet.jsp">Home
			...
			<ul class="navbar-nav ml-md-auto d-md-flex">
				<li class="nav-item">
					<button class="nav-link product-logout" style="background-color: gray">LogOut</button>
				</li>
			</ul>
		</div>
	</nav>
